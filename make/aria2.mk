...
#
# Binaries should be installed into $(ARIA2_IPK_DIR)$(TARGET_PREFIX)/sbin or $(ARIA2_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ARIA2_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(ARIA2_IPK_DIR)$(TARGET_PREFIX)/etc/aria2/...
# Documentation files should be installed in $(ARIA2_IPK_DIR)$(TARGET_PREFIX)/doc/aria2/...
# Daemon startup scripts should be installed in $(ARIA2_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??aria2
#
