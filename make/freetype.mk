...
FREETYPE_CONFFILES=$(TARGET_PREFIX)/etc/freetype.conf $(TARGET_PREFIX)/etc/init.d/SXXfreetype
...
#
# Binaries should be installed into $(FREETYPE_IPK_DIR)$(TARGET_PREFIX)/sbin or $(FREETYPE_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(FREETYPE_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(FREETYPE_IPK_DIR)$(TARGET_PREFIX)/etc/freetype/...
# Documentation files should be installed in $(FREETYPE_IPK_DIR)$(TARGET_PREFIX)/doc/freetype/...
# Daemon startup scripts should be installed in $(FREETYPE_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??freetype
#
